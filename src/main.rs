...
fn display_header() {
    ...
    println!(
        "{} {}",
        "🔧  cURL Request Generator".green().bold(),
        env!("VERSION").green().bold()
    );
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!();
}
...
fn display_configuration(cli: &Cli) {
    ...
    println!(
        "  {} {}",
        "📁  OpenAPI Source:".bold(),
        cli.openapi_path.as_ref().unwrap().cyan()
    );
    println!("  {} {}", "📂  Output Folder:".bold(), cli.output.cyan());
    println!(
        "  {} {}",
        "🌐  Content Type:".bold(),
        cli.content_type.cyan()
    );
...
fn display_statistics(document: &openapiv3::OpenAPI) {
    ...
    println!(
        "  {} {}",
        "📝  Path Items:".bold(),
        path_count.to_string().blue()
    );
    println!(
        "  {} {}",
        "⚙️  Operations:".bold(),
        operation_count.to_string().blue()
    );
    println!(
        "  {} {}",
        "📝  Parameters:".bold(),
        parameter_count.to_string().blue()
    );
    println!(
        "  {} {}",
        "📝  Schemas:".bold(),
        schema_count.to_string().blue()
    );
    println!();
}

fn display_results(
    result: &generator::GeneratorResult,
